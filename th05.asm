...
; The ZUN Soft logo and All Cast line animation now live in C++.
...
; The remaining registration, verdict, space-scene, bitmap, and staff-roll
; bodies now live in th05/regist.cpp, th05/staff.cpp, th05/space.cpp,
; th05/verd_bmp.cpp, and th05/staffrol.cpp. This root code contribution
...
public _hi01_pi, _scnum_bft, _sctm0_bft, _sctm1_bft, _SLOW_MODE_MSG, _BGM_NAME_FN
...
word_151E2	dw ?
	...
	; [verdict_bitmap] is a heap segment owned by the C++ staff-roll host.

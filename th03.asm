...
aVERDICT_PLAYCHARS label dword
		...
		dd aB@b@gggmgu_0	; "Å@Å@ÉGÉåÉì"
		dd aPmuexp_0		; "    è¨ìeïP"
		dd aGjgibegagigx_0	; "ÉJÉiÅEÉAÉiÉxÉâÉã"
...
aB@b@gggmgu_0	db 'Å@Å@ÉGÉåÉì',0
aPmuexp_0	db '    è¨ìeïP',0
aGjgibegagigx_0	db 'ÉJÉiÅEÉAÉiÉxÉâÉã',0
aB@tisqb@canb_0	db 'Å@í©ëqÅ@óùçÅéq',0
aCkftiB@vVfvs_0	db ' ñkîíâÕÅ@ÇøÇ‰ÇË',0
aB@iknsb@cF_0	db ' Å@â™çËÅ@ñ≤î¸',0
aVdvbvuvs	db '   ÇdÇÅÇìÇô',0
aVmvpvtvnvbvm	db ' ÇmÇèÇíÇçÇÅÇå',0
aVgvbvtvd	db '   ÇgÇÅÇíÇÑ',0
aVkvxvovbvfvivg	db 'ÇkÇïÇéÇÅÇîÇâÇÉ',0
aVo		db 'ÇO',0
aVp		db 'ÇP',0
aVq		db 'ÇQ',0
aVr		db 'ÇR',0

...
echo -c  -I.  -O  -b-  -3  -Z  -d  -DGAME=4  -ml  -DBINARY='M'  -nobj/th04/  th04/slowdown.cpp  th04/demo.cpp  th04/ems.cpp  th04/tile_set.cpp  th04/std.cpp  th04/map.cpp  th04/circle.cpp  th04/tile.cpp  th04/playfld.cpp  th04/midboss4.cpp  th04/f_dialog.cpp  th04/dialog.cpp  th04/boss_exp.cpp  th04/stages.cpp  th04/player_m.cpp  th04/player_p.cpp  th04/hud_ovrl.cpp  th04/cfg_lres.cpp  th04/checkerb.cpp  th04/mb_inv.cpp  th04/boss_bd.cpp  th04/score_rm.cpp  th04/mpn_free.cpp  th04/mpn_l_i.cpp>obj\batch015.@c

...
echo th02/op_music.cpp  th02/op/op_rplay.cpp  th02/op/rpyfont2.cpp  th02/lang_op.cpp  th02/lifecycle_diag.cpp  th02/op/op_memory_budget.cpp>>obj\batch006.@c
tcc @obj/batch006.@c

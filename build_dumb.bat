...
echo -c  -I.  -O  -b-  -3  -Z  -d  -DGAME=5  -ml  -DBINARY='E'  -nobj/th05/  th05/maine_e.cpp  th05/score_d.cpp  th05/hi_end.cpp  th05/cutscene.cpp  th05/allcast.cpp  th05/regist.cpp  th05/staff.cpp>obj\batch020.@c
tcc @obj/batch020.@c

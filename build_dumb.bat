...
echo -c  -I.  -O  -b-  -3  -Z  -d  -G  -k-  -p  -x-  -ml  -zCPLATFORM_TEXT  -DCPU=386  -nobj/platform/  game/\bgimage.cpp  game/\cutscene.cpp  game/\forkbann.cpp  game/\pi_surf.cpp  platform/x86real/\doserror.cpp  platform/x86real/\noexcept.cpp  platform/x86real/\novbuf.cpp  platform/x86real/\spawn.cpp  platform/x86real/\spawnenv.cpp  platform/x86real/pc98/\blitter.cpp  platform/x86real/pc98/\egc.cpp  platform/x86real/pc98/\font.cpp  platform/x86real/pc98/\graph.cpp  platform/x86real/pc98/\grcg.cpp>obj\batch001.@c
echo platform/x86real/pc98/\grp_clip.cpp  platform/x86real/pc98/\grp_surf.cpp  platform/x86real/pc98/\palette.cpp  platform/x86real/pc98/\vblank.cpp  platform/x86real/pc98/\vsync.cpp>>obj\batch001.@c
tcc @obj/batch001.@c

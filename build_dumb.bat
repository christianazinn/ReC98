...
echo -c  -I.  -O  -b-  -3  -Z  -d  -DGAME=4  -ml  -DBINARY='M'  -nobj/th04/  th04/slowdown.cpp  th04/entry.cpp  th04/stg_loop.cpp  th04/execl.cpp  th04/demo.cpp  th04/ems.cpp  th04/tile_set.cpp  th04/std.cpp  th04/end_ext.cpp  th04/map.cpp  th04/circle.cpp  th04/tile.cpp  th04/playfld.cpp  th04/midboss4.cpp  th04/midbossx.cpp  th04/f_dialog.cpp  th04/dialog.cpp  th04/boss_exp.cpp  th04/boss_5r.cpp  th04/boss_bg.cpp  th04/boss_fg.cpp  th04/mai.cpp  th04/stages.cpp  th04/hud_pnt.cpp>obj\batch015.@c
echo th04/hud_drm.cpp  th04/hud_put.cpp  th04/hud_grz.cpp  th04/hud_pwr.cpp  th04/player_b.cpp  th04/shot_inv.cpp  th04/player_m.cpp  th04/player_p.cpp  th04/main_01.cpp  th04/main_035.cpp  th04/hud_ovrl.cpp  th04/cfg_lres.cpp  th04/checkerb.cpp  th04/mb_inv.cpp  th04/boss_bd.cpp  th04/score_rm.cpp  th04/mpn_free.cpp  th04/mpn_l_i.cpp  th04/initmain.cpp  th04/gather.cpp  th04/std_run.cpp  th04/enm_btpl.cpp  th04/scrolly3.cpp  th04/midboss.cpp  th04/hud_hp.cpp  th04/mb_dft.cpp  th04/mb_dfr.cpp  th04/grcg_3.cpp  th04/it_spl_u.cpp  th04/enm_pos.cpp  th04/boss_4m.cpp>>obj\batch015.@c
echo th04/bullet_u.cpp  th04/bullet_a.cpp  th04/it_updt.cpp  th04/boss.cpp  th04/boss_4r.cpp  th04/boss_x2.cpp>>obj\batch015.@c
tcc @obj/batch015.@c
...
echo -c  -I.  -O  -b-  -3  -Z  -d  -DGAME=5  -ml  -DBINARY='E'  -nobj/th05/  th05/maine_e.cpp  th05/score_d.cpp  th05/hi_end.cpp  th05/cutscene.cpp  th05/allcast.cpp  th05/regist.cpp  th05/space.cpp  th05/staff.cpp>obj\batch020.@c
tcc @obj/batch020.@c

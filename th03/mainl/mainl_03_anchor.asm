...
T3CASE_MAINL_PAD_TEXT segment byte public 'CODE' use16
T3CASE_MAINL_PAD_TEXT ends
...
group_01 group CFG_LRES_TEXT, MAINL_SC_TEXT, CUTSCENE_TEXT, T3CASE_MAINL_PAD_TEXT, SCOREDAT_TEXT, REGIST_TEXT, STAFF_TEXT, mainl_03_TEXT

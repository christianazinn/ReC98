...
; Layout pin: the five master.lib procedures above grow _TEXT by 404 bytes,
; which is not a whole number of paragraphs, so the following main_01 group
; would keep its paragraph base while every symbol inside it shifted by the
; remainder.
	db 12 dup (0)

#ifndef TH03_MATH_RANDRING_HPP
#define TH03_MATH_RANDRING_HPP
...
inline subpixel_t randring1_next8_ge_lt_sp(float min, float max) {
	return randring1_next8_ge_lt(to_sp8(min), to_sp8(max));
}

inline subpixel_t randring1_next16_ge_lt_sp(float min, float max) {

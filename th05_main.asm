ifdef TH05_MAINTEXT_TAIL
; TH05 MAIN.EXE: the retained hand-written .MPN blitter and master.lib .PF
; hook, assembled as a separately ordered object through
; th05/maintext_tail.asm. Keeping these proc directives in the root dump
; also keeps both procedures visible to residue accounting.
...
; module at the head of PLAYER_B1_TEXT without moving the untouched suffix.
PN_INV_TEXT segment word public 'CODE' use16
; pointnums_init(), pointnums_invalidate(), and pointnums_update() now
; append here from th05/pn_inv.cpp.
PN_INV_TEXT ends
...
; is now split three ways. END_EXT_B_TEXT keeps the two prefix includes;
; YUMEKO_COLORFILL_TEXT anchors the C++ callback; and the suffix keeps
; END_EXT_TEXT so its existing th05/end_ext.cpp contribution stays put.
;
...
; Compiled from th05/main/boss/colorfill.cpp at this original address.
YUMEKO_COLORFILL_TEXT	segment	word public 'CODE' use16
	@YUMEKO_BACKDROP_COLORFILL$QV procdesc pascal near
YUMEKO_COLORFILL_TEXT	ends

; Original name retained on the suffix for th05/end_ext.cpp.

...
; of bytes prepended would drop it and move every symbol behind it. Of the
; eight bodies now in that object only yumeko_1D1C6(), yumeko_1D085() and
; yumeko_1CA42() are odd, and no shorter contiguous run of them from the

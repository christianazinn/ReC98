...
; Three public entry points share the dispatcher and case bodies below.
; Turbo C++ cannot represent control flow across function boundaries, so this
; deliberately remains one semantically named hand-written procedure.
bullet_template_tune_rank	proc
...
bullet_template_tune_rank	endp
BULLET_A_TEXT	ends

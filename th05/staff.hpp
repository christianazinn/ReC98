...
// Segment allocated for the two verdict screens while the staff roll runs.
extern dots8_t __seg *verdict_bitmap;
...
void near staffroll_animate_with_verdict_bitmap_on_heap(void);

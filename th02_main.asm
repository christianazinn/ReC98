...
; ELEVEN objects pick this segment up in link order, and that order is dump
; order:
;
...
aFW_8	db '８', 0
aFW_9	db '９', 0
; PLAIN RENAMES after lifting every address reference from the dump.
public _stage1_scenery_frame
_stage1_scenery_frame	dw 0
public _midboss1_defeat_frame
_midboss1_defeat_frame	dw 0
public _rika_defeat_frame
_rika_defeat_frame	dw 0
public _rika_bgm_fn
_rika_bgm_fn	db 'boss1.m',0
public _stage2_scenery_frame
_stage2_scenery_frame	dw 0
; Shared Stage 1 and 2 scenery lightning-flash clock. A PLAIN RENAME now
; that every address reference is in C++.
public _bg_flash_frame
_bg_flash_frame	dw 0
public _stage2_scenery_setup
_stage2_scenery_setup	db 1
		db 0
...
; PLAIN RENAMES after lifting every address reference from the dump.
public _rika_topleft
_rika_topleft	Point <?>
public _rika_move_state
_rika_move_state	dw ?
public _midboss1_active
_midboss1_active	dw ?
public _midboss1_patnum
_midboss1_patnum	dw ?
public _stage_scenery_particles
_stage_scenery_particles	db 600 dup(?)
public _rika_pattern_angle
_rika_pattern_angle	db ?
		db ?
public _rika_pattern_frame
_rika_pattern_frame	dw ?
...
_midboss2_active	dw ?
public _bg_flash_next_frame
_bg_flash_next_frame	dw ?

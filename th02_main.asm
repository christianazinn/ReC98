...
; now contributes nothing below mima_180EC(), and th02/boss_5.cpp's object
...
; TOGETHER for that reason - their lengths sum to 0x628; the two above them
; add 0x116 + 0x130 = 0x246; and the three above THOSE add
; 0x21D + 0x4DA + 0x5B = 0x752. Every one of those sums is EVEN. Read the

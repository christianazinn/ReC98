...
obj += {
	"th03/cfg_lres.cpp",
	"th03/op_01.cpp",
	{ "th03/mainl/screens_data.asm", extra_inputs = th03_sprites["flake"] },
...
th04:branch(MODEL_LARGE, SEMIOPTIM):link("debloat", obj)
...
th04:branch(MODEL_LARGE, SEMIOPTIM):link("debloatm", obj)
-- ----

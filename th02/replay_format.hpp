...
#define T2REPLAY_HEADER_WIRE_SIZE 256
#define T2REPLAY_HEADER_OPAQUE_OFFSET T2REPLAY_HEADER_SIZE
#define T2REPLAY_HEADER_OPAQUE_SIZE \
	(T2REPLAY_HEADER_WIRE_SIZE - T2REPLAY_HEADER_OPAQUE_OFFSET)
...
#define T2REPLAY_RESERVED_DOS_DATE_OFFSET \
	(T2REPLAY_RESERVED_NAME_OFFSET + T2REPLAY_NAME_LEN)
#define T2REPLAY_RESERVED_DOS_TIME_OFFSET \
	(T2REPLAY_RESERVED_DOS_DATE_OFFSET + 2)
#define T2REPLAY_RESERVED_TAIL_OFFSET T2REPLAY_RESERVED_DOS_DATE_OFFSET
...
enum t2replay_practice_target_t {
	...
	T2RPT_STAGE4_BOSS_ROUND4 = 35,
	T2RPT_STAGE4_BOSS_ROUND5 = 36,
	T2RPT_STAGE4_BOSS_ROUND6 = 37,
	T2RPT_STAGE4_BOSS_ROUND7 = 38,
	T2RPT_STAGE3_NORTH_PHASE4 = 39,
	T2RPT_STAGE5_BOSS_PHASE9 = 40,
	T2RPT_EXTRA_BOSS_PHASE7 = 41,
	T2RPT_EXTRA_BOSS_PHASE9 = 42,
	T2RPT_STAGE1_CHAPTER3 = 43,
	T2RPT_STAGE1_CHAPTER4 = 44,
	T2RPT_STAGE1_PRE_BOSS = 45,
	T2RPT_STAGE2_CHAPTER3 = 46,
	T2RPT_STAGE2_CHAPTER4 = 47,
	T2RPT_STAGE2_CHAPTER5 = 48,
	T2RPT_STAGE2_CHAPTER6 = 49,
	T2RPT_STAGE2_PRE_BOSS = 50,
	T2RPT_STAGE3_CHAPTER3 = 51,
	T2RPT_STAGE3_CHAPTER4 = 52,
	T2RPT_STAGE3_CHAPTER5 = 53,
	T2RPT_STAGE3_CHAPTER6 = 54,
	T2RPT_STAGE3_PRE_BOSS = 55,
	T2RPT_STAGE4_CHAPTER4 = 56,
	T2RPT_STAGE4_CHAPTER5 = 57,
	T2RPT_STAGE4_CHAPTER6 = 58,
	T2RPT_STAGE4_CHAPTER7 = 59,
	T2RPT_STAGE4_PRE_BOSS = 60,
	T2RPT_STAGE5_PRE_BOSS = 61,
	T2RPT_EXTRA_CHAPTER3 = 62,
	T2RPT_EXTRA_CHAPTER4 = 63,
	T2RPT_EXTRA_CHAPTER5 = 64,
	T2RPT_EXTRA_CHAPTER6 = 65,
	T2RPT_EXTRA_CHAPTER7 = 66,
	T2RPT_EXTRA_CHAPTER8 = 67,
	T2RPT_EXTRA_CHAPTER9 = 68,
	T2RPT_EXTRA_CHAPTER10 = 69,
	T2RPT_EXTRA_CHAPTER11 = 70,
	T2RPT_EXTRA_PRE_BOSS = 71,
	T2RPT_STAGE3_NORTH_PHASE6 = 72,
	T2RPT_STAGE3_NORTH_PHASE8 = 73,
};
...
#define T2REPLAY_AUTOFIRE_OFFSET 3
#define T2REPLAY_PRACTICE_RESERVED_OFFSET 4
#define T2REPLAY_PRACTICE_RESERVED_SIZE 1

...
// The value column of the labelled HUD rows.
static const utram_x_t HUD_POINT_ITEMS_LEFT = (HUD_LEFT + 6);

#if (GAME == 5)
	// Below the gs_TEN label that hud_put() draws at (58, 16).
	static const utram_y_t HUD_POINT_ITEMS_STAGE_Y = 16;

	// Below the gsRUIKEI ("cumulative") label that hud_put() draws at
	// (57, 15).

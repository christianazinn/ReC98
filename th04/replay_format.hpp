...
// The in-memory structure remains the public prefix. V7 appends an opaque,
// zero-initialized extension tail on disk for external metadata.
#define REPLAY_USER_HEADER_SIZE 192
#define REPLAY_USER_HEADER_WIRE_SIZE 320
#define REPLAY_USER_HEADER_OPAQUE_OFFSET REPLAY_USER_HEADER_SIZE
#define REPLAY_USER_HEADER_OPAQUE_SIZE \
	(REPLAY_USER_HEADER_WIRE_SIZE - REPLAY_USER_HEADER_OPAQUE_OFFSET)
...
#define REPLAY_USER_INPUT_OFFSET \
	(REPLAY_USER_HEADER_WIRE_SIZE + REPLAY_STAGE_DIRECTORY_SIZE)
#define REPLAY_USER_INPUT_OFFSET_LEGACY \

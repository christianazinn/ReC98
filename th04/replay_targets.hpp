...
static uint16_t replay_practice_chapter_frame(uint8_t stage, uint8_t chapter)
{
	if(chapter == 1) {
		...
		case 0:
			switch(chapter) {
			case 2: return 1900; case 3: return 2800;
			case 4: return 5400; case 5: return 7550; case 6: return 7800;
			}
			break;
		case 1:
			if(chapter == 2) return 2200;
			if(chapter == 3) return 3400;
			break;
		case 2:
			switch(chapter) {
			case 2: return 1200; case 3: return 2800; case 4: return 4000;
			case 5: return 6200; case 6: return 9000;
			}
			break;
		case 3:
			if(chapter == 2) return 5000;
			if(chapter == 3) return 6800;
			if(chapter == 4) return 11000;
			break;
		case 4:
			switch(chapter) {
			case 2: return 1300; case 3: return 2500; case 4: return 3700;
			case 5: return 4400; case 6: return 5400; case 7: return 7800;
			}
			break;
		case 5:
		...
		case STAGE_EXTRA:
			switch(chapter) {
			case 2: return 1800; case 3: return 5600;
			case 4: return 7000; case 5: return 10500;
			}
			break;
		}
	#else
		switch(stage) {
		case 0:
			if(chapter == 2) return 1320;
			if(chapter == 3) return 3400;
			if(chapter == 4) return 5800;
			break;
		case 1:
			if(chapter == 2) return 2800;
			if(chapter == 3) return 5000;
			if(chapter == 4) return 6500;
			break;
		case 2:
			switch(chapter) {
			case 2: return 2100; case 3: return 3220;
			case 4: return 7200; case 5: return 7900;
			}
			break;
		case 3:
			switch(chapter) {
			case 2: return 800; case 3: return 1400; case 4: return 1700;
			case 5: return 3400; case 6: return 5200; case 7: return 6500;
			case 8: return 8900; case 9: return 9200; case 10: return 9700;
			case 11: return 10600; case 12: return 11000;
		...
		case 5:
			switch(chapter) {
			case 2: return 3100; case 3: return 4000; case 4: return 4300;
			case 5: return 4600; case 6: return 4900;
			}
			break;
		case STAGE_EXTRA:
			switch(chapter) {
			case 2: return 2000; case 3: return 3550;
			case 4: return 8000; case 5: return 9900;
			}
			break;
		}
	#endif

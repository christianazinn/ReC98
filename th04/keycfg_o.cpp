...
struct keyconfig_strings_t {
	...
	char text_could_not_save_th5key_cfg[26];
	char text_could_not_save_th4key_cfg[26];
};
...
static void keyconfig_strings_init(void)
{
	...
	keyconfig_strings.text_th4key[0] = 84;
	keyconfig_strings.text_th4key[1] = 72;
#if (GAME == 5)
	keyconfig_strings.text_th4key[2] = 53;
#else
	keyconfig_strings.text_th4key[2] = 52;
#endif
	keyconfig_strings.text_th4key[3] = 75; keyconfig_strings.text_th4key[4] = 69;
	keyconfig_strings.text_th4key[5] = 89; keyconfig_strings.text_th4key[6] = 46;
	keyconfig_strings.text_th4key[7] = 36; keyconfig_strings.text_th4key[8] = 36;
	keyconfig_strings.text_th4key[9] = 36; keyconfig_strings.text_th4key[10] = 0;

	keyconfig_strings.text_th4key_bak[0] = 84;
	keyconfig_strings.text_th4key_bak[1] = 72;
#if (GAME == 5)
	keyconfig_strings.text_th4key_bak[2] = 53;
#else
	keyconfig_strings.text_th4key_bak[2] = 52;
#endif
	keyconfig_strings.text_th4key_bak[3] = 75; keyconfig_strings.text_th4key_bak[4] = 69;
	keyconfig_strings.text_th4key_bak[5] = 89; keyconfig_strings.text_th4key_bak[6] = 46;
	keyconfig_strings.text_th4key_bak[7] = 66; keyconfig_strings.text_th4key_bak[8] = 65;
	keyconfig_strings.text_th4key_bak[9] = 75; keyconfig_strings.text_th4key_bak[10] = 0;
	...
	keyconfig_strings.text_restore_defaults[0] = 82; keyconfig_strings.text_restore_defaults[1] = 101;
	keyconfig_strings.text_restore_defaults[2] = 115; keyconfig_strings.text_restore_defaults[3] = 116;
	keyconfig_strings.text_restore_defaults[4] = 111; keyconfig_strings.text_restore_defaults[5] = 114;
	keyconfig_strings.text_restore_defaults[6] = 101; keyconfig_strings.text_restore_defaults[7] = 32;
	keyconfig_strings.text_restore_defaults[8] = 100; keyconfig_strings.text_restore_defaults[9] = 101;
	keyconfig_strings.text_restore_defaults[10] = 102; keyconfig_strings.text_restore_defaults[11] = 97;
	keyconfig_strings.text_restore_defaults[12] = 117; keyconfig_strings.text_restore_defaults[13] = 108;
	keyconfig_strings.text_restore_defaults[14] = 116; keyconfig_strings.text_restore_defaults[15] = 115;
	keyconfig_strings.text_restore_defaults[16] = 0; keyconfig_strings.text_apply_and_return[0] = 65;
	keyconfig_strings.text_apply_and_return[1] = 112; keyconfig_strings.text_apply_and_return[2] = 112;
	keyconfig_strings.text_apply_and_return[3] = 108; keyconfig_strings.text_apply_and_return[4] = 121;
	keyconfig_strings.text_apply_and_return[5] = 32; keyconfig_strings.text_apply_and_return[6] = 97;
	keyconfig_strings.text_apply_and_return[7] = 110; keyconfig_strings.text_apply_and_return[8] = 100;
	keyconfig_strings.text_apply_and_return[9] = 32; keyconfig_strings.text_apply_and_return[10] = 114;
	keyconfig_strings.text_apply_and_return[11] = 101; keyconfig_strings.text_apply_and_return[12] = 116;
	keyconfig_strings.text_apply_and_return[13] = 117; keyconfig_strings.text_apply_and_return[14] = 114;
	keyconfig_strings.text_apply_and_return[15] = 110; keyconfig_strings.text_apply_and_return[16] = 0;
	keyconfig_strings.text_cancel[0] = 67; keyconfig_strings.text_cancel[1] = 97;
	keyconfig_strings.text_cancel[2] = 110; keyconfig_strings.text_cancel[3] = 99;
	keyconfig_strings.text_cancel[4] = 101; keyconfig_strings.text_cancel[5] = 108;
	keyconfig_strings.text_cancel[6] = 0; 

	keyconfig_strings.text_each_action_needs_at_least_one_key[0] = 69; keyconfig_strings.text_each_action_needs_at_least_one_key[1] = 97;
	keyconfig_strings.text_each_action_needs_at_least_one_key[2] = 99; keyconfig_strings.text_each_action_needs_at_least_one_key[3] = 104;
	keyconfig_strings.text_each_action_needs_at_least_one_key[4] = 32; keyconfig_strings.text_each_action_needs_at_least_one_key[5] = 97;
	keyconfig_strings.text_each_action_needs_at_least_one_key[6] = 99; keyconfig_strings.text_each_action_needs_at_least_one_key[7] = 116;
	keyconfig_strings.text_each_action_needs_at_least_one_key[8] = 105; keyconfig_strings.text_each_action_needs_at_least_one_key[9] = 111;
	keyconfig_strings.text_each_action_needs_at_least_one_key[10] = 110; keyconfig_strings.text_each_action_needs_at_least_one_key[11] = 32;
	keyconfig_strings.text_each_action_needs_at_least_one_key[12] = 110; keyconfig_strings.text_each_action_needs_at_least_one_key[13] = 101;
	keyconfig_strings.text_each_action_needs_at_least_one_key[14] = 101; keyconfig_strings.text_each_action_needs_at_least_one_key[15] = 100;
	keyconfig_strings.text_each_action_needs_at_least_one_key[16] = 115; keyconfig_strings.text_each_action_needs_at_least_one_key[17] = 32;
	keyconfig_strings.text_each_action_needs_at_least_one_key[18] = 97; keyconfig_strings.text_each_action_needs_at_least_one_key[19] = 116;
	keyconfig_strings.text_each_action_needs_at_least_one_key[20] = 32; keyconfig_strings.text_each_action_needs_at_least_one_key[21] = 108;
	keyconfig_strings.text_each_action_needs_at_least_one_key[22] = 101; keyconfig_strings.text_each_action_needs_at_least_one_key[23] = 97;
	keyconfig_strings.text_each_action_needs_at_least_one_key[24] = 115; keyconfig_strings.text_each_action_needs_at_least_one_key[25] = 116;
	keyconfig_strings.text_each_action_needs_at_least_one_key[26] = 32; keyconfig_strings.text_each_action_needs_at_least_one_key[27] = 111;
	keyconfig_strings.text_each_action_needs_at_least_one_key[28] = 110; keyconfig_strings.text_each_action_needs_at_least_one_key[29] = 101;
	keyconfig_strings.text_each_action_needs_at_least_one_key[30] = 32; keyconfig_strings.text_each_action_needs_at_least_one_key[31] = 107;
	keyconfig_strings.text_each_action_needs_at_least_one_key[32] = 101; keyconfig_strings.text_each_action_needs_at_least_one_key[33] = 121;
	keyconfig_strings.text_each_action_needs_at_least_one_key[34] = 46; keyconfig_strings.text_each_action_needs_at_least_one_key[35] = 0;

	keyconfig_strings.text_that_key_is_the_action_s_only_binding[0] = 84; keyconfig_strings.text_that_key_is_the_action_s_only_binding[1] = 104;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[2] = 97; keyconfig_strings.text_that_key_is_the_action_s_only_binding[3] = 116;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[4] = 32; keyconfig_strings.text_that_key_is_the_action_s_only_binding[5] = 107;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[6] = 101; keyconfig_strings.text_that_key_is_the_action_s_only_binding[7] = 121;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[8] = 32; keyconfig_strings.text_that_key_is_the_action_s_only_binding[9] = 105;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[10] = 115; keyconfig_strings.text_that_key_is_the_action_s_only_binding[11] = 32;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[12] = 116; keyconfig_strings.text_that_key_is_the_action_s_only_binding[13] = 104;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[14] = 101; keyconfig_strings.text_that_key_is_the_action_s_only_binding[15] = 32;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[16] = 97; keyconfig_strings.text_that_key_is_the_action_s_only_binding[17] = 99;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[18] = 116; keyconfig_strings.text_that_key_is_the_action_s_only_binding[19] = 105;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[20] = 111; keyconfig_strings.text_that_key_is_the_action_s_only_binding[21] = 110;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[22] = 39; keyconfig_strings.text_that_key_is_the_action_s_only_binding[23] = 115;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[24] = 32; keyconfig_strings.text_that_key_is_the_action_s_only_binding[25] = 111;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[26] = 110; keyconfig_strings.text_that_key_is_the_action_s_only_binding[27] = 108;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[28] = 121; keyconfig_strings.text_that_key_is_the_action_s_only_binding[29] = 32;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[30] = 98; keyconfig_strings.text_that_key_is_the_action_s_only_binding[31] = 105;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[32] = 110; keyconfig_strings.text_that_key_is_the_action_s_only_binding[33] = 100;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[34] = 105; keyconfig_strings.text_that_key_is_the_action_s_only_binding[35] = 110;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[36] = 103; keyconfig_strings.text_that_key_is_the_action_s_only_binding[37] = 46;
	keyconfig_strings.text_that_key_is_the_action_s_only_binding[38] = 0; keyconfig_strings.text_every_action_needs_one_unique_key[0] = 69;
	keyconfig_strings.text_every_action_needs_one_unique_key[1] = 118; keyconfig_strings.text_every_action_needs_one_unique_key[2] = 101;
	keyconfig_strings.text_every_action_needs_one_unique_key[3] = 114; keyconfig_strings.text_every_action_needs_one_unique_key[4] = 121;
	keyconfig_strings.text_every_action_needs_one_unique_key[5] = 32; keyconfig_strings.text_every_action_needs_one_unique_key[6] = 97;
	keyconfig_strings.text_every_action_needs_one_unique_key[7] = 99; keyconfig_strings.text_every_action_needs_one_unique_key[8] = 116;
	keyconfig_strings.text_every_action_needs_one_unique_key[9] = 105; keyconfig_strings.text_every_action_needs_one_unique_key[10] = 111;
	keyconfig_strings.text_every_action_needs_one_unique_key[11] = 110; keyconfig_strings.text_every_action_needs_one_unique_key[12] = 32;
	keyconfig_strings.text_every_action_needs_one_unique_key[13] = 110; keyconfig_strings.text_every_action_needs_one_unique_key[14] = 101;
	keyconfig_strings.text_every_action_needs_one_unique_key[15] = 101; keyconfig_strings.text_every_action_needs_one_unique_key[16] = 100;
	keyconfig_strings.text_every_action_needs_one_unique_key[17] = 115; keyconfig_strings.text_every_action_needs_one_unique_key[18] = 32;
	keyconfig_strings.text_every_action_needs_one_unique_key[19] = 111; keyconfig_strings.text_every_action_needs_one_unique_key[20] = 110;
	keyconfig_strings.text_every_action_needs_one_unique_key[21] = 101; keyconfig_strings.text_every_action_needs_one_unique_key[22] = 32;
	keyconfig_strings.text_every_action_needs_one_unique_key[23] = 117; keyconfig_strings.text_every_action_needs_one_unique_key[24] = 110;
	keyconfig_strings.text_every_action_needs_one_unique_key[25] = 105; keyconfig_strings.text_every_action_needs_one_unique_key[26] = 113;
	keyconfig_strings.text_every_action_needs_one_unique_key[27] = 117; keyconfig_strings.text_every_action_needs_one_unique_key[28] = 101;
	keyconfig_strings.text_every_action_needs_one_unique_key[29] = 32; keyconfig_strings.text_every_action_needs_one_unique_key[30] = 107;
	keyconfig_strings.text_every_action_needs_one_unique_key[31] = 101; keyconfig_strings.text_every_action_needs_one_unique_key[32] = 121;
	keyconfig_strings.text_every_action_needs_one_unique_key[33] = 46; keyconfig_strings.text_every_action_needs_one_unique_key[34] = 0;
	keyconfig_strings.text_could_not_save_th5key_cfg[0] = 67; keyconfig_strings.text_could_not_save_th5key_cfg[1] = 111;
	keyconfig_strings.text_could_not_save_th5key_cfg[2] = 117; keyconfig_strings.text_could_not_save_th5key_cfg[3] = 108;
	keyconfig_strings.text_could_not_save_th5key_cfg[4] = 100; keyconfig_strings.text_could_not_save_th5key_cfg[5] = 32;
	keyconfig_strings.text_could_not_save_th5key_cfg[6] = 110; keyconfig_strings.text_could_not_save_th5key_cfg[7] = 111;
	keyconfig_strings.text_could_not_save_th5key_cfg[8] = 116; keyconfig_strings.text_could_not_save_th5key_cfg[9] = 32;
	keyconfig_strings.text_could_not_save_th5key_cfg[10] = 115; keyconfig_strings.text_could_not_save_th5key_cfg[11] = 97;
	keyconfig_strings.text_could_not_save_th5key_cfg[12] = 118; keyconfig_strings.text_could_not_save_th5key_cfg[13] = 101;
	keyconfig_strings.text_could_not_save_th5key_cfg[14] = 32; keyconfig_strings.text_could_not_save_th5key_cfg[15] = 84;
	keyconfig_strings.text_could_not_save_th5key_cfg[16] = 72; keyconfig_strings.text_could_not_save_th5key_cfg[17] = 53;
	keyconfig_strings.text_could_not_save_th5key_cfg[18] = 75; keyconfig_strings.text_could_not_save_th5key_cfg[19] = 69;
	keyconfig_strings.text_could_not_save_th5key_cfg[20] = 89; keyconfig_strings.text_could_not_save_th5key_cfg[21] = 46;
	keyconfig_strings.text_could_not_save_th5key_cfg[22] = 67; keyconfig_strings.text_could_not_save_th5key_cfg[23] = 70;
	keyconfig_strings.text_could_not_save_th5key_cfg[24] = 71; keyconfig_strings.text_could_not_save_th5key_cfg[25] = 0;
	keyconfig_strings.text_could_not_save_th4key_cfg[0] = 67; keyconfig_strings.text_could_not_save_th4key_cfg[1] = 111;
	keyconfig_strings.text_could_not_save_th4key_cfg[2] = 117; keyconfig_strings.text_could_not_save_th4key_cfg[3] = 108;
	keyconfig_strings.text_could_not_save_th4key_cfg[4] = 100; keyconfig_strings.text_could_not_save_th4key_cfg[5] = 32;
	keyconfig_strings.text_could_not_save_th4key_cfg[6] = 110; keyconfig_strings.text_could_not_save_th4key_cfg[7] = 111;
	keyconfig_strings.text_could_not_save_th4key_cfg[8] = 116; keyconfig_strings.text_could_not_save_th4key_cfg[9] = 32;
	keyconfig_strings.text_could_not_save_th4key_cfg[10] = 115; keyconfig_strings.text_could_not_save_th4key_cfg[11] = 97;
	keyconfig_strings.text_could_not_save_th4key_cfg[12] = 118; keyconfig_strings.text_could_not_save_th4key_cfg[13] = 101;
	keyconfig_strings.text_could_not_save_th4key_cfg[14] = 32; keyconfig_strings.text_could_not_save_th4key_cfg[15] = 84;
	keyconfig_strings.text_could_not_save_th4key_cfg[16] = 72; keyconfig_strings.text_could_not_save_th4key_cfg[17] = 52;
	keyconfig_strings.text_could_not_save_th4key_cfg[18] = 75; keyconfig_strings.text_could_not_save_th4key_cfg[19] = 69;
	keyconfig_strings.text_could_not_save_th4key_cfg[20] = 89; keyconfig_strings.text_could_not_save_th4key_cfg[21] = 46;
	keyconfig_strings.text_could_not_save_th4key_cfg[22] = 67; keyconfig_strings.text_could_not_save_th4key_cfg[23] = 70;
	keyconfig_strings.text_could_not_save_th4key_cfg[24] = 71; keyconfig_strings.text_could_not_save_th4key_cfg[25] = 0;
...
#define KEYCONFIG_ROW_DEFAULTS KCA_COUNT
#define KEYCONFIG_ROW_APPLY (KCA_COUNT + 1)
#define KEYCONFIG_ROW_CANCEL (KCA_COUNT + 2)
#define KEYCONFIG_ROW_COUNT (KCA_COUNT + 3)
...
static bool keyconfig_bindings_valid(const uint8_t __ss *bindings)
{
	...
	for(i = 0; i < KEYCONFIG_BINDING_COUNT; i++) {
		...
		if(bindings[i] != KEYCONFIG_KEY_UNBOUND) {
			for(j = 0; j < i; j++) {
...
static const char *keyconfig_magic(void)
{
#if (GAME == 5)
	return keyconfig_strings.text_t5key001;
#else
	return keyconfig_strings.text_t4key001;
#endif
}
...
{
	return (
		(keyconfig_mem_compare(cfg.magic, keyconfig_magic(), 8) == 0) &&
...
static bool keyconfig_file_save(const keyconfig_menu_t __ss& menu)
{
	...
	keyconfig_mem_copy(cfg.magic, keyconfig_magic(), 8);
	cfg.version = KEYCONFIG_VERSION;
	cfg.size = sizeof(cfg);
	...
	return keyconfig_file_replace(
		keyconfig_strings.text_th4key_cfg, keyconfig_strings.text_th4key,
		keyconfig_strings.text_th4key_bak, &cfg, sizeof(cfg)
	);
}
...
static void keyconfig_text_put(unsigned x, unsigned y, const char far *text, unsigned attr)
{
	if(y >= 25) {
		return;
	}
	for(; *text && (x < 80); x++, text++) {
		unsigned offset = (((y * 80) + x) * sizeof(uint16_t));
		poke(SEG_TRAM_JIS, offset, static_cast<uint8_t>(*text));
		poke(SEG_TRAM_ATRB, offset, attr);
	}
}
...
)
{
	...
	text_clear();
	keyconfig_text_put(30, 1, keyconfig_strings.text_key_configuration, TX_YELLOW);
	keyconfig_text_put(27, 3, keyconfig_strings.text_primary, TX_WHITE);
	keyconfig_text_put(50, 3, keyconfig_strings.text_alternate, TX_WHITE);
	for(uint8_t row = 0; row < KEYCONFIG_ROW_COUNT; row++) {
		...
		keyconfig_text_put(0, (5 + row), line, (row == selected) ? TX_CYAN : TX_WHITE);
	}
	if(message) {
		keyconfig_text_put(10, 23, message, TX_CYAN);
	}
}
...
static uint8_t keyconfig_raw_first(void)
{
	...
	return KEYCONFIG_KEY_UNBOUND;
}

static void keyconfig_raw_wait_release(void)
{
	while(keyconfig_raw_first() != KEYCONFIG_KEY_UNBOUND) {
		frame_delay(1);
	}
}
...
static uint8_t keyconfig_capture(void)
{
	...
	do {
		...
		if(key == KEYCONFIG_KEY_UNBOUND) frame_delay(1);
	} while(key == KEYCONFIG_KEY_UNBOUND);
	keyconfig_raw_wait_release();
	return key;
}
...
)
{
	...
	for(uint8_t i = 0; i < KEYCONFIG_BINDING_COUNT; i++) {
		if((i != index) && (menu.bindings[i] == key)) {
			if(
				(old_key == KEYCONFIG_KEY_UNBOUND) &&
				(menu.bindings[(i ^ 1)] == KEYCONFIG_KEY_UNBOUND)
			) {
				return false;
			}
...
{
	return (keyconfig_mem_compare(a.bindings, b.bindings, sizeof(a.bindings)) == 0);
}
	...
	while(1) {
		...
		if(previous == INPUT_NONE) {
			if(key_det & INPUT_UP) {
				...
				if(menu.bindings[index ^ 1] != KEYCONFIG_KEY_UNBOUND) {
					menu.bindings[index] = KEYCONFIG_KEY_UNBOUND;
					keyconfig_screen_put(menu, selected, column, 0);
				} else {
				...
				if(selected < KCA_COUNT) {
					...
					if(!keyconfig_bindings_valid(menu.bindings)) {
						...
						keyconfig_screen_put(menu, selected, column,
#if (GAME == 5)
							keyconfig_strings.text_could_not_save_th5key_cfg);
#else
							keyconfig_strings.text_could_not_save_th4key_cfg);
#endif
					}
				} else if(

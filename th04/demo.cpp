// stage_transition(), and then pause(), were the last two things
// th04_main.asm contributed to DEMO_TEXT and this object is the next
// contribution behind them, so listing their files FIRST, in that order,
// grows this object backwards into the hole and puts both bodies back at

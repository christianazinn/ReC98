...
#define T1REPLAY_KONNGARA_PHASE1_NATURAL_TRACE (T1RP == 6)
#define T1REPLAY_KONNGARA_PHASE1_DIRECT_TRACE (T1RP == 8)
#define T1REPLAY_KONNGARA_PHASE1_TRACE ( \
...
#define T1REPLAY_FLAG_PRACTICE 0x0004
#define T1REPLAY_FLAGS_REQUIRED (T1REPLAY_FLAG_RLE | T1REPLAY_FLAG_KEY_LATCH)
#define T1REPLAY_FLAGS_KNOWN (T1REPLAY_FLAGS_REQUIRED | T1REPLAY_FLAG_PRACTICE)

...
enum t1replay_process_milestone_t {
	...
	T1RPM_BOSS_PHASE_CONSTRUCTED = 46,
	T1RPM_BOSS_PHASE_REJECTED = 47,
	T1RPM_BOSS_PHASE_GAMEPLAY = 48,
	T1RPM_KIKURI_INITIAL_STATE_REJECTED = 49,
	T1RPM_KIKURI_SOUL_RESOURCE_REJECTED = 50,
	T1RPM_KIKURI_TEAR_RESOURCE_REJECTED = 51,
	T1RPM_KIKURI_SNAPSHOT_REJECTED = 52,
	T1RPM_KIKURI_PHASE_NOT_ZERO = 53,
	T1RPM_KIKURI_FRAME_NOT_ZERO = 54,
	T1RPM_KIKURI_HP_NOT_FULL = 55,
	T1RPM_KIKURI_PTN_MISSING = 56,
	T1RPM_KIKURI_PTN_COUNT_WRONG = 57,
};

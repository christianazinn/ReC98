...
enum t1replay_process_milestone_t {
	...
	T1RPM_PRACTICE_SURFACE_READY = 38,
	T1RPM_PRACTICE_RESTART_ARMED = 39,
	T1RPM_PRACTICE_FONT_READY = 40,
	T1RPM_PRACTICE_STATE_READY = 41,
	T1RPM_PRACTICE_PANEL_ALLOC_FAILED = 42,
	T1RPM_PRACTICE_PANEL_DECODE_BEGIN = 43,
	T1RPM_PRACTICE_PANEL_DECODE_READY = 44,
	T1RPM_PRACTICE_PANEL_DECODE_FAILED = 45,
};

...
struct keyconfig_strings_t {
	...
	char text_could_not_save_th1key_cfg[26];
};
...
static void keyconfig_strings_init(void)
{
	...
	keyconfig_strings.text_th1key[0] = 84;
	keyconfig_strings.text_th1key[1] = 72; keyconfig_strings.text_th1key[2] = 49;
	keyconfig_strings.text_th1key[3] = 75; keyconfig_strings.text_th1key[4] = 69;
	keyconfig_strings.text_th1key[5] = 89; keyconfig_strings.text_th1key[6] = 46;
	keyconfig_strings.text_th1key[7] = 36; keyconfig_strings.text_th1key[8] = 36;
	keyconfig_strings.text_th1key[9] = 36; keyconfig_strings.text_th1key[10] = 0;

	keyconfig_strings.text_th1key_bak[0] = 84;
	keyconfig_strings.text_th1key_bak[1] = 72; keyconfig_strings.text_th1key_bak[2] = 49;
	keyconfig_strings.text_th1key_bak[3] = 75; keyconfig_strings.text_th1key_bak[4] = 69;
	keyconfig_strings.text_th1key_bak[5] = 89; keyconfig_strings.text_th1key_bak[6] = 46;
	keyconfig_strings.text_th1key_bak[7] = 66; keyconfig_strings.text_th1key_bak[8] = 65;
	keyconfig_strings.text_th1key_bak[9] = 75; keyconfig_strings.text_th1key_bak[10] = 0;
	...
	keyconfig_strings.text_shot[4] = 0; keyconfig_strings.text_strike[0] = 83;
	keyconfig_strings.text_strike[1] = 116; keyconfig_strings.text_strike[2] = 114;
	keyconfig_strings.text_strike[3] = 105; keyconfig_strings.text_strike[4] = 107;
	keyconfig_strings.text_strike[5] = 101; keyconfig_strings.text_strike[6] = 0;
	keyconfig_strings.text_fs[0] = 37; keyconfig_strings.text_fs[1] = 70;
	keyconfig_strings.text_fs[2] = 115; keyconfig_strings.text_fs[3] = 0;
	...
	keyconfig_strings.text_could_not_save_th1key_cfg[0] = 67; keyconfig_strings.text_could_not_save_th1key_cfg[1] = 111;
	keyconfig_strings.text_could_not_save_th1key_cfg[2] = 117; keyconfig_strings.text_could_not_save_th1key_cfg[3] = 108;
	keyconfig_strings.text_could_not_save_th1key_cfg[4] = 100; keyconfig_strings.text_could_not_save_th1key_cfg[5] = 32;
	keyconfig_strings.text_could_not_save_th1key_cfg[6] = 110; keyconfig_strings.text_could_not_save_th1key_cfg[7] = 111;
	keyconfig_strings.text_could_not_save_th1key_cfg[8] = 116; keyconfig_strings.text_could_not_save_th1key_cfg[9] = 32;
	keyconfig_strings.text_could_not_save_th1key_cfg[10] = 115; keyconfig_strings.text_could_not_save_th1key_cfg[11] = 97;
	keyconfig_strings.text_could_not_save_th1key_cfg[12] = 118; keyconfig_strings.text_could_not_save_th1key_cfg[13] = 101;
	keyconfig_strings.text_could_not_save_th1key_cfg[14] = 32; keyconfig_strings.text_could_not_save_th1key_cfg[15] = 84;
	keyconfig_strings.text_could_not_save_th1key_cfg[16] = 72; keyconfig_strings.text_could_not_save_th1key_cfg[17] = 49;
	keyconfig_strings.text_could_not_save_th1key_cfg[18] = 75; keyconfig_strings.text_could_not_save_th1key_cfg[19] = 69;
	keyconfig_strings.text_could_not_save_th1key_cfg[20] = 89; keyconfig_strings.text_could_not_save_th1key_cfg[21] = 46;
	keyconfig_strings.text_could_not_save_th1key_cfg[22] = 67; keyconfig_strings.text_could_not_save_th1key_cfg[23] = 70;
	keyconfig_strings.text_could_not_save_th1key_cfg[24] = 71; keyconfig_strings.text_could_not_save_th1key_cfg[25] = 0;
...
static bool keyconfig_bindings_valid(const uint8_t __ss *bindings)
{
	...
	for(i = 0; i < T1_KEYCONFIG_BINDING_COUNT; i++) {
		...
		if(bindings[i] != T1_KEYCONFIG_KEY_UNBOUND) {
			for(j = 0; j < i; j++) {
	...
	for(action = 0; action < KCA_COUNT; action++) {
		...
		for(i = 0; i < T1_KEYCONFIG_BINDINGS_PER_ACTION; i++) {
			if(bindings[(action * 2) + i] != T1_KEYCONFIG_KEY_UNBOUND) {
				bound = true;
			}
		}
		if(!bound) {
...
{
	for(uint8_t i = 0; i < sizeof(cfg.reserved); i++) {
		if(cfg.reserved[i] != 0) return false;
	}
	return (
...
static bool keyconfig_file_save(const keyconfig_menu_t __ss& menu)
{
	...
	keyconfig_mem_copy(cfg.magic, keyconfig_strings.text_t1key001, 8);
	cfg.version = T1_KEYCONFIG_VERSION;
	cfg.size = sizeof(cfg);
	keyconfig_mem_copy(cfg.bindings, menu.bindings, sizeof(cfg.bindings));
	keyconfig_mem_fill(cfg.reserved, 0, sizeof(cfg.reserved));
	cfg.checksum = keyconfig_checksum(cfg);
	return keyconfig_file_replace(
		keyconfig_strings.text_th1key_cfg, keyconfig_strings.text_th1key,
		keyconfig_strings.text_th1key_bak, &cfg, sizeof(cfg)
	);
}
...
)
{
	...
	default: return keyconfig_line_puts(line, at, keyconfig_strings.text_strike);
	}
}

static void keyconfig_text_put(
	tram_x_t x, tram_y_t y, int color, const char far *text
)
{
	z_text_vputsa(x, y, color, keyconfig_strings.text_fs, text);
}
...
)
{
	...
	z_text_clear();
	keyconfig_text_put(30, 1, Z_ATRB_YELLOW, keyconfig_strings.text_key_configuration);
	keyconfig_text_put(27, 3, Z_ATRB_WHITE, keyconfig_strings.text_primary);
	keyconfig_text_put(50, 3, Z_ATRB_WHITE, keyconfig_strings.text_alternate);
	for(uint8_t row = 0; row < KEYCONFIG_ROW_COUNT; row++) {
		...
		keyconfig_text_put(
			0, (6 + row), (row == selected) ? Z_ATRB_CYAN : Z_ATRB_WHITE,
			line
		);
	}
	if(message) {
		keyconfig_text_put(10, 20, Z_ATRB_CYAN, message);
	}
}
...
static uint8_t keyconfig_raw_first(void)
{
	...
	return T1_KEYCONFIG_KEY_UNBOUND;
}

static uint8_t keyconfig_ui_input(void)
{
	uint8_t input = KCUI_NONE;
	uint8_t group_7 = peekb(0, KEYGROUP_7);

	if(group_7 & K7_ARROW_UP) input |= KCUI_UP;
	if(group_7 & K7_ARROW_DOWN) input |= KCUI_DOWN;
	if(group_7 & K7_ARROW_LEFT) input |= KCUI_LEFT;
	if(group_7 & K7_ARROW_RIGHT) input |= KCUI_RIGHT;
	if(
		(peekb(0, KEYGROUP_5) & K5_Z) ||
		(peekb(0, KEYGROUP_3) & K3_RETURN)
	) input |= KCUI_OK;
	if(peekb(0, KEYGROUP_0) & K0_ESC) input |= KCUI_CANCEL;
	if(peekb(0, KEYGROUP_5) & K5_X) input |= KCUI_CLEAR;
	return input;
}

static void keyconfig_raw_wait_release(void)
{
	while(keyconfig_raw_first() != T1_KEYCONFIG_KEY_UNBOUND) {
		frame_delay(1);
	}
}
...
static uint8_t keyconfig_capture(void)
{
	...
	do {
		...
		if(key == T1_KEYCONFIG_KEY_UNBOUND) frame_delay(1);
	} while(key == T1_KEYCONFIG_KEY_UNBOUND);
	keyconfig_raw_wait_release();
	return key;
}
...
)
{
	...
	for(uint8_t i = 0; i < T1_KEYCONFIG_BINDING_COUNT; i++) {
		if((i != index) && (menu.bindings[i] == key)) {
			if(
				(old_key == T1_KEYCONFIG_KEY_UNBOUND) &&
				(menu.bindings[(i ^ 1)] == T1_KEYCONFIG_KEY_UNBOUND)
			) {
				return false;
			}
...
{
	uint8_t previous = keyconfig_ui_input();

	keyconfig_screen_put(menu, KEYCONFIG_ROW_CANCEL, 0,
		keyconfig_strings.text_discard);
	while(1) {
		uint8_t input = keyconfig_ui_input();
		if(previous == KCUI_NONE) {
			if(input & KCUI_OK) return true;
			if(input & KCUI_CANCEL) return false;
		}
		previous = input;
		frame_delay(1);
	}
	...
	while(1) {
		...
		if(previous == KCUI_NONE) {
			if(input & KCUI_UP) {
				...
				keyconfig_screen_put(menu, selected, column, 0);
			} else if(input & KCUI_DOWN) {
				selected = ((selected + 1) % KEYCONFIG_ROW_COUNT);
				keyconfig_screen_put(menu, selected, column, 0);
			} else if(input & (KCUI_LEFT | KCUI_RIGHT)) {
				if(selected < KCA_COUNT) column ^= 1;
				keyconfig_screen_put(menu, selected, column, 0);
			} else if((input & KCUI_CLEAR) && (selected < KCA_COUNT)) {
				uint8_t index = ((selected * 2) + column);
				if(menu.bindings[index ^ 1] != T1_KEYCONFIG_KEY_UNBOUND) {
					menu.bindings[index] = T1_KEYCONFIG_KEY_UNBOUND;
					keyconfig_screen_put(menu, selected, column, 0);
				} else {
					keyconfig_screen_put(menu, selected, column,
						keyconfig_strings.text_each_action_needs_at_least_one_key);
				}
			} else if(input & KCUI_OK) {
				if(selected < KCA_COUNT) {
					...
					if(!keyconfig_bindings_valid(menu.bindings)) {
						...
						keyconfig_screen_put(menu, selected, column,
							keyconfig_strings.text_could_not_save_th1key_cfg);
					}
				} else if(
